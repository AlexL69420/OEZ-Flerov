...
export function MainContent() {
    ...
    const handleSubmit = async () => {
        ...
        await axios
            .post
            (`${LOCAL_API_URL}cards/api/medicine/create_card/`, data,
    ...
    return (
        <main
            className="flex min-h-screen w-screen flex-row justify-center  gap-2 bg-white px-1 py-3 text-black dark:bg-slate-600 dark:text-white">
